      ...
      <div className="flex min-h-screen flex-col bg-muted p-8">
        <div className="mx-auto w-full max-w-screen-md">
          <div className="space-y-2">
            <h1 className="text-2xl md:text-4xl">Basis Pengetahuan</h1>
            <p className="text-muted-foreground">Unggah dan kelola dokumen untuk asisten AI Anda</p>
          </div>
          ...
          <div className="mt-8 rounded-lg border bg-background">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead className="px-6 py-4 font-medium">Nama</TableHead>
                  <TableHead className="px-6 py-4 font-medium">Tipe</TableHead>
                  <TableHead className="px-6 py-4 font-medium">Ukuran</TableHead>
                  <TableHead className="px-6 py-4 font-medium">Aksi</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {(() => {
