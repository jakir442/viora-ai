  ...
  return (
    <div className="border-t bg-background">
      <Table>
        <TableHeader>
          <TableRow>
            <TableHead className="px-6 py-4">Nomor Telepon</TableHead>
          ...
          {(() => {
            ...
            if (phoneNumbers.length === 0) {
              return (
                <TableRow>
                  <TableCell colSpan={3} className="px-6 py-8 text-center text-muted-foreground">
                    Tidak ada nomor telepon yang dikonfigurasi
                  </TableCell>
                </TableRow>
              );
            }
              ...
              <TableRow className="hover:bg-muted/50" key={phone.id}>
                <TableCell className="px-6 py-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-mono">{phone.number || "Belum dikonfigurasi"}</span>
                  </div>
                </TableCell>
                <TableCell className="px-6 py-4">{phone.name || "Tanpa nama"}</TableCell>
                <TableCell className="px-6 py-4">
                  <Badge
