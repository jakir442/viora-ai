(function () {
  "use strict";
  const o = { WIDGET_URL: "https://viora-ai-widget.vercel.app", DEFAULT_POSITION: "bottom-right" },
  ...
  (function () {
    ...
    ((window.VioraWidget = { init: v, show: m, hide: u, destroy: x }), h());
  })();
})();
