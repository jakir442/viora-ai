...
export const AIMessageContent = ({ children, className, ...props }: AIMessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:border-transparent group-[.is-user]:bg-gradient-to-b group-[.is-user]:from-primary group-[.is-user]:to-[#29a00b] group-[.is-user]:text-primary-foreground",
      className
    )}
    {...props}
  >
